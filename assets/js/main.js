var app = new Vue({
	...
	data: {
		...
		products: [
			{
				...
				desc: {
          characteristics: 'The most recognizable of the sweet pepper varieties are bell peppers, which are also the most commonly available. Bell peppers are easy to grow in the garden, and abundantly available in the produce section of your grocery store, generally in either green, red, yellow, or orange. But there is so much more variety than those four colors among bell peppers!',
          plant:[
        ...
        desc: {
          characteristics: 'These compact and sturdy plants produce purple bell peppers with a lime green interior. Purple colors do not hold up to cooking, so they are most stunning when eaten fresh! Their color can range from slight purple to a purple so dark it is almost black. These are some of my favorites!',
          plant:[
        ...
        desc: {
          characteristics: 'This variety gets its name from the beak-like point at the blossom end of the red bell pepper. Plants are small and compact and perfect for growing in containers on a deck or patio. These are sweet and delicious peppers when eaten fresh, but cooking them unlocks even more sweetness.',
          plant:[
